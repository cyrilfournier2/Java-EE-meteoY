...
public class StationAutonomePOJO extends StationPOJO implements Serializable{
	...
	public StationAutonomePOJO( String nom, int x, int y, List<AppareilPOJO> listeAppareil,AppareilPOJO materiel) {
		super();
	...
	public AppareilPOJO getMateriel() {
		return materiel;
	}



	public void setMateriel(AppareilPOJO materiel) {
		this.materiel = materiel;
	}
}
